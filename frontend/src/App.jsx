    ...
    return (
        <Router>
            <Routes>
                ...
                <Route path="/login" element={user ? (<Dashboard user={user} onLogout={() => setUser(null)} />) : (<Login onLogin={setUser} />)} />
                <Route path="/register" element={user ? (<Dashboard user={user} onLogout={() => setUser(null)} />) : (<Register />)} />
